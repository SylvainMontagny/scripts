...
export class GatewayStats extends jspb.Message {
  ...
  clearDutyCycleStats(): void;
  getDutyCycleStats(): DutyCycleStats | undefined;
  setDutyCycleStats(value?: DutyCycleStats): void;
...
export class DutyCycleStats extends jspb.Message {
  getRegulation(): common_common_pb.RegulationMap[keyof common_common_pb.RegulationMap];
  setRegulation(value: common_common_pb.RegulationMap[keyof common_common_pb.RegulationMap]): void;

  hasWindow(): boolean;
  clearWindow(): void;
  getWindow(): google_protobuf_duration_pb.Duration | undefined;
  setWindow(value?: google_protobuf_duration_pb.Duration): void;

  clearBandsList(): void;
  getBandsList(): Array<DutyCycleBand>;
  setBandsList(value: Array<DutyCycleBand>): void;
...
export namespace DutyCycleStats {
  export type AsObject = {
    regulation: common_common_pb.RegulationMap[keyof common_common_pb.RegulationMap],
...
export class DutyCycleBand extends jspb.Message {
  ...
  setFrequencyMin(value: number): void;

  getFrequencyMax(): number;
  setFrequencyMax(value: number): void;

  hasLoadMax(): boolean;
  clearLoadMax(): void;
  getLoadMax(): google_protobuf_duration_pb.Duration | undefined;
  setLoadMax(value?: google_protobuf_duration_pb.Duration): void;

  hasLoadTracked(): boolean;
  clearLoadTracked(): void;
  getLoadTracked(): google_protobuf_duration_pb.Duration | undefined;
  setLoadTracked(value?: google_protobuf_duration_pb.Duration): void;
...
export class MeshHeartbeat extends jspb.Message {
  getGatewayId(): string;
  setGatewayId(value: string): void;

  getRelayId(): string;
  setRelayId(value: string): void;
  ...
  clearRelayPathList(): void;
  getRelayPathList(): Array<MeshHeartbeatRelayPath>;
  setRelayPathList(value: Array<MeshHeartbeatRelayPath>): void;
  addRelayPath(value?: MeshHeartbeatRelayPath, index?: number): MeshHeartbeatRelayPath;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MeshHeartbeat.AsObject;
  static toObject(includeInstance: boolean, msg: MeshHeartbeat): MeshHeartbeat.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: MeshHeartbeat, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MeshHeartbeat;
  static deserializeBinaryFromReader(message: MeshHeartbeat, reader: jspb.BinaryReader): MeshHeartbeat;
}

export namespace MeshHeartbeat {
  export type AsObject = {
    gatewayId: string,
    relayId: string,
    time?: google_protobuf_timestamp_pb.Timestamp.AsObject,
    relayPathList: Array<MeshHeartbeatRelayPath.AsObject>,
  }
}

export class MeshHeartbeatRelayPath extends jspb.Message {
  getRelayId(): string;
  setRelayId(value: string): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): MeshHeartbeatRelayPath.AsObject;
  static toObject(includeInstance: boolean, msg: MeshHeartbeatRelayPath): MeshHeartbeatRelayPath.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: MeshHeartbeatRelayPath, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): MeshHeartbeatRelayPath;
  static deserializeBinaryFromReader(message: MeshHeartbeatRelayPath, reader: jspb.BinaryReader): MeshHeartbeatRelayPath;
}

export namespace MeshHeartbeatRelayPath {
  export type AsObject = {
    relayId: string,
    rssi: number,
    snr: number,
